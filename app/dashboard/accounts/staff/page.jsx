...
function MetricCard({icon: Icon, label, value, tone = "slate"}) {
    ...
    return (
        <article
            className="flex min-h-[96px] items-center gap-4 rounded-xl border border-[#d4dbe8] bg-white px-5 py-4 shadow-[0_8px_22px_rgba(15,23,42,0.04)]">
...
export default function StaffAccountsPage() {
    ...
    return (
        <div className="grid gap-7 text-[#0f1d33]">
            ...
            <section
                className="rounded-xl border border-[#c8ceda] bg-white px-5 py-5 shadow-[0_8px_22px_rgba(15,23,42,0.04)]">
            ...
            <section
                className="overflow-hidden rounded-xl border border-[#c8ceda] bg-white shadow-[0_8px_22px_rgba(15,23,42,0.04)]">
                ...
                {loading ? (
                    <div
                        className="flex min-h-[260px] items-center justify-center text-sm font-semibold text-[#526179]">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full min-w-[980px] text-left text-sm">
                            <thead
                                className="bg-[#f7f9fb] text-xs font-bold uppercase tracking-[0.06em] text-[#687184]">
                            <tr>
                          ...
                          <span
                              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#ecf3ff] text-xs font-bold text-[#465fff]">
            ...
            {createOpen ? (
                ...
                >
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div
                            className="rounded-lg border border-dashed border-[#c8ceda] bg-[#f8fafc] p-4 md:col-span-2">
