...
export default function ContractWorkflowStepper({ contractDetails, refreshKey = 0, onContractUpdated, onRequestShowHandover, onActivate, leaseVersion = 0, isActivating = false }) {
  ...
  return (
    <div className="mb-6 overflow-visible rounded-2xl border border-slate-200 bg-gradient-to-b from-slate-50/60 to-white shadow-sm">
      {/* ── Header ── */}
      <div className="flex flex-col gap-5 rounded-t-2xl border-b border-slate-100 bg-white px-4 py-5 dark:bg-[#0f172a] sm:px-6 md:flex-row md:items-center md:justify-between md:px-8">
        ...
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center md:justify-end">
          {/* Progress pill */}
          <div className="flex w-full min-w-0 items-center justify-center gap-2.5 rounded-full border border-slate-200 bg-slate-50 px-3.5 py-1.5 sm:w-auto">
          ...
          {(() => {
            ...
            if (allDone) {
              return (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-3 text-sm font-extrabold text-white shadow-lg shadow-emerald-500/25 transition-all hover:from-emerald-700 hover:to-teal-700 hover:shadow-xl hover:shadow-emerald-500/30 disabled:opacity-60 disabled:shadow-none sm:w-auto sm:px-6"
                >
                  {isActivating ? (
            ...
            return (
              <button
                disabled
                className="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-xl bg-slate-100 px-4 py-2.5 text-sm font-extrabold text-slate-400 sm:w-auto sm:px-5"
              >
      ...
      {/* ── Phase labels ── */}
      <div className={`hidden md:grid ${phaseGridClass} gap-0 border-b border-slate-100 bg-white px-8 dark:border-white/10 dark:bg-[#0f172a]`}>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="min-w-0">
                    <h3 className={`text-sm font-extrabold leading-tight ${state.done ? "text-emerald-800 dark:text-emerald-300" : "text-slate-800 dark:text-slate-100"}`}>
                      {meta.title}
                    </h3>
