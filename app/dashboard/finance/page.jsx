  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-5 text-[#0f1d33]">
      <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-[-0.02em]">Báo cáo doanh thu</h1>
          <p className="mt-1 text-sm text-[#5f6b7c]">Phân tích dòng tiền và hiệu quả kinh doanh</p>
