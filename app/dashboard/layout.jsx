...
function Topbar({search, onSearchChange, onToggleMobileMenu}) {
    ...
    return (
        <header
            className="sticky top-0 z-20 flex min-h-16 items-center justify-between gap-4 border-b border-[#e2e8f0] bg-white px-4 shadow-[0_1px_1px_rgba(0,0,0,0.05)] sm:px-6 lg:ml-[280px]">
