...
const TEMPLATE_RECIPIENT_ROLES_BY_EVENT = {
  ...
  INVOICE_OVERDUE_REMINDER_1: ["TENANT"],
  INVOICE_OVERDUE_REMINDER_2: ["TENANT"],
  INVOICE_OVERDUE_REMINDER_3: ["TENANT"],
  INVOICE_OVERDUE_OWNER_STAGE_1: ["MANAGER", "OWNER"],
  INVOICE_OVERDUE_OWNER_STAGE_2: ["MANAGER", "OWNER"],
  INVOICE_OVERDUE_OWNER_STAGE_3: ["MANAGER", "OWNER"],
  INVOICE_PAID: ["TENANT"],
