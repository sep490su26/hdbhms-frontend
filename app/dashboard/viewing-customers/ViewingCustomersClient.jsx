      ...
      <div>
        <div className="mx-auto max-w-[1440px]">
          ...
          <section className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.08em] text-[#505f76]">Quản lý vận hành</p>
              <h1 className="mt-2 text-2xl font-bold tracking-[-0.01em] text-[#191c1e]">Danh sách khách xem phòng</h1>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-[#45474c]">Quản lý và theo dõi lịch hẹn xem phòng của khách tiềm năng.</p>
            </div>
