...
test("toDate treats server ISO datetimes without timezone as Vietnam local time", () => {
...
test("formatDateTime renders Vietnam local time for naive datetimes", () => {
  const { formatDateTime } = loadDateFormat();

  assert.equal(formatDateTime("2026-07-28T10:00:00"), "28/07/2026 10:00:00");
  assert.equal(formatDateTime("2026-07-28T03:00:00Z"), "28/07/2026 10:00:00");
});
