...
function mapRoomTransfer(data) {
    return {
        ...
        oldContractStatus: data.oldContractStatus ?? null,
        ...
        targetContractStatus: data.targetContractStatus ?? null,
        newContractId: data.newContractId,
        newContractStatus: data.newContractStatus ?? null,
        replacementOldContractId: data.replacementOldContractId,
        replacementOldContractStatus: data.replacementOldContractStatus ?? null,
